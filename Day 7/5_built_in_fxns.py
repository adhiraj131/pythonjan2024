...
# max()
# It also takes an iterable as an input and returns the maximum from that iterable

print(max(4,5,1,8,10)) # 10


# min()
# It also takes an iterable as an input and returns the minimum from that iterable
